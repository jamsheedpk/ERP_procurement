...
/*
 * Procurement Lifecycle — 12-stage flow.
...
const PROC_STAGES = [
  ...
  { key: "proforma",            label: "Proforma Recv",       department: "Procurement",      action: "Collect Invoice for Payment",         responsible: "Accounts" },
  { key: "payment_req",         label: "Payment Req",         department: "Accountant",       action: "Generate Payment Application",        responsible: "Project Manager" },
...
// step 7 — subcontractor payment application (progress / running bill).
...
const procurementSchema = new mongoose.Schema({
  ...
  paymentApplications:[paymentAppSchema],          // step 7 — payment application per vendor
  poNumber:       { type: String, default: "" },   // legacy single-PO fields
  poDate:         { type: String, default: "" },
  poAmount:       { type: Number, default: 0 },
  invoiceNumber:  { type: String, default: "" },   // step 8 — Proforma / invoice
  invoiceAmount:  { type: Number, default: 0 },
  paymentMethod:  { type: String, default: "" },   // step 11 — Payment release
  paymentRef:     { type: String, default: "" },
  paymentAmount:  { type: Number, default: 0 },
  paymentDate:    { type: String, default: "" },
  deliveryNote:   { type: String, default: "" },   // step 12 — Logistics
